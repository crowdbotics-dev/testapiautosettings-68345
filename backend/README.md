...
## Project Structure
    ...
    ├── testapiautosettings_68345  # Django project configurations
...
1. Clone this repo and `cd testapiautosettings_68345`
...
2. Clone this repo and `cd testapiautosettings_68345`
